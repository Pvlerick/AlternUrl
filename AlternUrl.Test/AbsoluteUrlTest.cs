...
namespace AlternUrl.Test
{
    public class AbsoluteUrlTest
    {
        ...
        public void Constructor_Success()
        {
            // Fixture setup
            // Exercise system
            var url = new AbsoluteUrl("http://username:password@example.com:8042/over/there/index.dtb?type=animal&name=narwhal#nose");
            // Verify outcome
        ...
        [Fact]
        public void ConstructWithNullUrlThrows()
        {
            Assert.Throws<ArgumentNullException>(() => new AbsoluteUrl(null));
        }

        [Theory]
        [InlineData("")]
        [InlineData("foo")]
        [InlineData("ftp://hello")] //Invalid scheme for an url
        public void ConstructWithInvalidUrlThrows(String url)
        {
            Assert.Throws<ArgumentException>(() => new AbsoluteUrl(url));
        }
        ...
        public void FileName_HasFileName_And_Extension_HasExtension(String urlText, String expectedFileName, bool expectedHasFileName, String expectedExtension, bool expectedHasExtension)
        {
            // Fixture setup
            // Exercise system
            var url = new AbsoluteUrl(urlText);
            // Verify outcome
        ...
        [Theory]
        [MemberData("TestData")]
        public void Scheme(AbsoluteUrlTestData urlData)
        {
            var url = new AbsoluteUrl(urlData.Url);
        ...
        [Theory]
        [MemberData("TestData")]
        public void UserInfo(AbsoluteUrlTestData urlData)
        {
            var url = new AbsoluteUrl(urlData.Url);
        ...
        [Theory]
        [MemberData("TestData")]
        public void Host(AbsoluteUrlTestData urlData)
        {
            var url = new AbsoluteUrl(urlData.Url);
        ...
        [Theory]
        [MemberData("TestData")]
        public void Port(AbsoluteUrlTestData urlData)
        {
            var url = new AbsoluteUrl(urlData.Url);
        ...
        [Theory]
        [MemberData("TestData")]
        public void Path(AbsoluteUrlTestData urlData)
        {
            var url = new AbsoluteUrl(urlData.Url);
        ...
        [Theory]
        [MemberData("TestData")]
        public void Query(AbsoluteUrlTestData urlData)
        {
            var url = new AbsoluteUrl(urlData.Url);
        ...
        [Theory]
        [MemberData("TestData")]
        public void Fragment(AbsoluteUrlTestData urlData)
        {
            var url = new AbsoluteUrl(urlData.Url);
        ...
        //[Theory]
        //[MemberData("TestData")]
        //public void Normalized(AbsoluteUrlTestData urlData)
        //{
        //    var url = new AbsoluteUrl(urlData.Url);
        ...
        public class AbsoluteUrlTestData
        {
            ...
            public AbsoluteUrlTestData(String url, String urlToString, String scheme, String userInfo, String host, int port, String path, String query, String fragment)
            {
                this.Url = url;
        ...
        public static IEnumerable TestData
        {
            get
                {
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com","http://www.google.com/","http","","www.google.com",80,"/","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("HTTP://WWW.GOOGLE.COM","http://www.google.com/","http","","www.google.com",80,"/","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/","http://www.google.com/","http","","www.google.com",80,"/","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail","http://www.google.com/mail","http","","www.google.com",80,"/mail","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://WWW.GOOGLE.COM/mail","http://www.google.com/mail","http","","www.google.com",80,"/mail","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://WWW.GOOGLE.COM/MAIL","http://www.google.com/MAIL","http","","www.google.com",80,"/MAIL","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/","http://www.google.com/mail/","http","","www.google.com",80,"/mail/","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/hello.html","http://www.google.com/hello.html","http","","www.google.com",80,"/hello.html","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.htm","http://www.google.com/mail/hello.htm","http","","www.google.com",80,"/mail/hello.htm","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html","http://www.google.com/mail/hello.html","http","","www.google.com",80,"/mail/hello.html","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html#","http://www.google.com/mail/hello.html","http","","www.google.com",80,"/mail/hello.html","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html#anchor","http://www.google.com/mail/hello.html#anchor","http","","www.google.com",80,"/mail/hello.html","", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?","http://www.google.com/mail/hello.html","http","","www.google.com",80,"/mail/hello.html","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?#","http://www.google.com/mail/hello.html","http","","www.google.com",80,"/mail/hello.html","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?foo","http://www.google.com/mail/hello.html?foo","http","","www.google.com",80,"/mail/hello.html","foo", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?foo=12","http://www.google.com/mail/hello.html?foo=12","http","","www.google.com",80,"/mail/hello.html","foo=12", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?foo=12&bar","http://www.google.com/mail/hello.html?foo=12&bar","http","","www.google.com",80,"/mail/hello.html","foo=12&bar", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?foo=12&bar=34","http://www.google.com/mail/hello.html?foo=12&bar=34","http","","www.google.com",80,"/mail/hello.html","foo=12&bar=34", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?foo","http://www.google.com/mail/hello.html?foo","http","","www.google.com",80,"/mail/hello.html","foo", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?foo#anchor","http://www.google.com/mail/hello.html?foo#anchor","http","","www.google.com",80,"/mail/hello.html","foo", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?foo=12","http://www.google.com/mail/hello.html?foo=12","http","","www.google.com",80,"/mail/hello.html","foo=12", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?foo=12#anchor","http://www.google.com/mail/hello.html?foo=12#anchor","http","","www.google.com",80,"/mail/hello.html","foo=12", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?foo=12&bar","http://www.google.com/mail/hello.html?foo=12&bar","http","","www.google.com",80,"/mail/hello.html","foo=12&bar", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?foo=12&bar=34","http://www.google.com/mail/hello.html?foo=12&bar=34","http","","www.google.com",80,"/mail/hello.html","foo=12&bar=34", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/hello.html?foo=12&bar=34#anchor","http://www.google.com/mail/hello.html?foo=12&bar=34#anchor","http","","www.google.com",80,"/mail/hello.html","foo=12&bar=34", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/hello","http://www.google.com/hello","http","","www.google.com",80,"/hello","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail#","http://www.google.com/mail","http","","www.google.com",80,"/mail","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail#anchor","http://www.google.com/mail#anchor","http","","www.google.com",80,"/mail","", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?","http://www.google.com/mail","http","","www.google.com",80,"/mail","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?#","http://www.google.com/mail","http","","www.google.com",80,"/mail","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?foo","http://www.google.com/mail?foo","http","","www.google.com",80,"/mail","foo", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?foo=12","http://www.google.com/mail?foo=12","http","","www.google.com",80,"/mail","foo=12", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?foo=12&bar","http://www.google.com/mail?foo=12&bar","http","","www.google.com",80,"/mail","foo=12&bar", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?foo=12&bar=34","http://www.google.com/mail?foo=12&bar=34","http","","www.google.com",80,"/mail","foo=12&bar=34", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?foo","http://www.google.com/mail?foo","http","","www.google.com",80,"/mail","foo", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?foo#anchor","http://www.google.com/mail?foo#anchor","http","","www.google.com",80,"/mail","foo", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?foo=12","http://www.google.com/mail?foo=12","http","","www.google.com",80,"/mail","foo=12", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?foo=12#anchor","http://www.google.com/mail?foo=12#anchor","http","","www.google.com",80,"/mail","foo=12", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?foo=12&bar","http://www.google.com/mail?foo=12&bar","http","","www.google.com",80,"/mail","foo=12&bar", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?foo=12&bar=34","http://www.google.com/mail?foo=12&bar=34","http","","www.google.com",80,"/mail","foo=12&bar=34", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail?foo=12&bar=34#anchor","http://www.google.com/mail?foo=12&bar=34#anchor","http","","www.google.com",80,"/mail","foo=12&bar=34", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/","http://www.google.com/mail/","http","","www.google.com",80,"/mail/","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/#","http://www.google.com/mail/","http","","www.google.com",80,"/mail/","", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/#anchor","http://www.google.com/mail/#anchor","http","","www.google.com",80,"/mail/","", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/?","http://www.google.com/mail/","http","","www.google.com",80,"/mail/","", "") };
                    ...
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/?foo=12&bar=34","http://www.google.com/mail/?foo=12&bar=34","http","","www.google.com",80,"/mail/","foo=12&bar=34", "") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/?foo=12&bar=34#anchor","http://www.google.com/mail/?foo=12&bar=34#anchor","http","","www.google.com",80,"/mail/","foo=12&bar=34", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://root:mypass@www.google.com/mail/?foo=12&bar=34#anchor","http://root:mypass@www.google.com/mail/?foo=12&bar=34#anchor","http","root:mypass","www.google.com",80,"/mail/","foo=12&bar=34", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://root:mypass@www.google.com:90/mail/?foo=12&bar=34#anchor","http://root:mypass@www.google.com:90/mail/?foo=12&bar=34#anchor","http","root:mypass","www.google.com",90,"/mail/","foo=12&bar=34", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("https://root:mypass@www.google.com/mail/?foo=12&bar=34#anchor","https://root:mypass@www.google.com/mail/?foo=12&bar=34#anchor","https","root:mypass","www.google.com",443,"/mail/","foo=12&bar=34", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("https://root:mypass@www.google.com:444/mail/?foo=12&bar=34#anchor","https://root:mypass@www.google.com:444/mail/?foo=12&bar=34#anchor","https","root:mypass","www.google.com",444,"/mail/","foo=12&bar=34", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://root:mypass@www.google.com/mail/?foo=12&bar=34#anchor","http://root:mypass@www.google.com/mail/?foo=12&bar=34#anchor","http","root:mypass","www.google.com",80,"/mail/","foo=12&bar=34", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("http://www.google.com/mail/?foo=12&bar=34#anchor","http://www.google.com/mail/?foo=12&bar=34#anchor","http","","www.google.com",80,"/mail/","foo=12&bar=34", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("https://root:mypass@www.google.com/mail/?foo=12&bar=34#anchor","https://root:mypass@www.google.com/mail/?foo=12&bar=34#anchor","https","root:mypass","www.google.com",443,"/mail/","foo=12&bar=34", "anchor") };
                    yield return new object[] { new AbsoluteUrlTestData("https://www.google.com/mail/?foo=12&bar=34#anchor","https://www.google.com/mail/?foo=12&bar=34#anchor","https","","www.google.com",443,"/mail/","foo=12&bar=34", "anchor") };
            }
        }
    }
}
